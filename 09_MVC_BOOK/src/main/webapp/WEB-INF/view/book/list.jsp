		...
		<main class="layout">
			...
			<section
				...
				<form class="d-flex"
					...
					</select> <input name="keyword" style="width: 200px;"
			...
			<section class="show-book">
				...
				<table class="table w-100" style="margin: 20px 0;">
					...
					<tbody>
						...
						<tr>
							<td><a
								href="${pageContext.request.contextPath}/book/read?bookCode=<%=dto.getBookCode() %>">
									<%=dto.getBookCode()%>
							</a></td>
					...
					<tfoot>
						<tr>
								...
								<nav aria-label="Page navigation example">
									<ul class="pagination">
										...
										<li class="page-item"><a class="page-link"
											href="${pageContext.request.contextPath}/book/list?pageno=<%=pageDto.getStartPage() - 1%>"
										...
										%>
										<li class="page-item"><a class="page-link"
											href="${pageContext.request.contextPath}/book/list?pageno=<%=pageDto.getStartPage() - 1%>&type=<%=type%>&keyword=<%=keyword%>"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
										...
										<li class="page-item">
											...
											if (type == null) {
											%> <a class="page-link"
											href="${pageContext.request.contextPath}/book/list?pageno=<%=i%>"><%=i%></a>
											<%
											} else {
											%> <a class="page-link"
											href="${pageContext.request.contextPath}/book/list?pageno=<%=i%>&type=<%=type%>&keyword=<%=keyword%>"><%=i%></a>
											<%
											}
											%>
										</li>
							...
							<td style="text-align: right">
								<!-- 글쓰기/처음으로 버튼 --> <a class="btn btn-success m-2" href="">글쓰기</a>
